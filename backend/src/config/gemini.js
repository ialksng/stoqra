...
// Automatically alias legacy or deprecated models (including 2.5-pro) to active gemini-3.5-flash-lite
if (!rawModel || /^gemini-(1\.5|2\.0|2\.5-pro)/i.test(rawModel) || !/^gemini-(2\.5|3\.[0-9])/i.test(rawModel)) {
